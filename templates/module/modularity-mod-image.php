...
if (isset($fields['mod_image_link_url']) && strlen($fields['mod_image_link_url']) > 0) {
    echo '<a href="' . $fields['mod_image_link_url'] . '"><img class="box box__image" src="' . $imageSrc . '" alt="' . $fields['mod_image_image']['alt'] . '" class="' . implode(' ', apply_filters('', $classes)) . '"></a>';
} else {
    echo '<img class="box box__image" src="' . $imageSrc . '" alt="' . $fields['mod_image_image']['alt'] . '" class="' . implode(' ', apply_filters('', $classes)) . '">';
}