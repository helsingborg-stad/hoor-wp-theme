...
<div class="container main-container">
    ...
    <div class="grid {{ (wp_get_post_parent_id(get_the_id()) != 0) ? 'no-margin-top' : '' }}">
        <div class="grid-lg-3 hidden-print">
            <a class="o-button o-button--primary o-button--more" href="/nyheter"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512"><path d="M427 234.625H167.296l119.702-119.702L256 85 85 256l171 171 29.922-29.924-118.626-119.701H427v-42.75z"/></svg> <?php _e('More events', 'hoor'); ?></a>
        </div>
