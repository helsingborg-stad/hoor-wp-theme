<div id="translate" class="c-google-translate {{ get_field('show_google_translate', 'option') != 'fold' ? 'c-google-translate--static' : 'c-google-translate--fixed' }} target-toggle">
    <h3>Translate</h3>
