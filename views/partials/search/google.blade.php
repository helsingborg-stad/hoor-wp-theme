                    ...
                    <div class="grid-lg-12">
                        <ul class="search-result">
                            ...
                            <li class="search-result__item">
                                ...
                                <time class="search-result__date">{{ apply_filters('Municipio/search_result/date', $search->getModifiedDate($item), false) }}</time>
                                <p class="search-result__excerpt">{!! apply_filters('Municipio/search_result/excerpt', trim($item->snippet), false) !!}</p>
                                <div class="search-result__details">
                                    <span class="search-result__url"><a href="{{ apply_filters('Municipio/search_result/permalink_url', $item->link, false) }}">{!! apply_filters('Municipio/search_result/permalink_text', $item->htmlFormattedUrl, false) !!}</a></span>
                                </div>
                            </li>
                            @endforeach
